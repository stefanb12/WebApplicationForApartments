Vue.component("all-notActiveApartmentsByHost", {
	data: function () {
	    return {
	      apartments: null
	    }
...
<div style="position: absolute;
  ...
  top: 150px;">
		...
		<button v-on:click="activeSwitch" style="position: relative;
		  left: 90px;
		  top: 0px;
		">
...
`
	...
	methods : {
		activeSwitch : function() {
			this.$router.push('/allActiveApartmentsByHost');  
    	}
	},
	
	mounted () {
		axios
        .get('rest/apartments/inactiveApartmentsByHost')
