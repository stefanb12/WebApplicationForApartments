Vue.component("all-activeApartmentsByHost", {
	data: function () {
	    return {
	      apartments: null
	    }
...
<div style="position: absolute;
  ...
  top: 150px;">
		...
		<button style="position: relative;
		  ...
		  color: azure;
		">
		Aktivni Apartmani</button>
		
		<button v-on:click="inActiveSwitch" style="position: relative;
		  left: 120px;
		  top: 0px;
		">
		NeaktivniApartmani</button>
...
`
	...
	methods : {
		inActiveSwitch : function() {
			this.$router.push('/allNotActiveApartmentsByHost');  
    	}
	},
	
	mounted () {
		axios
        .get('rest/apartments/activeApartmentsByHost')
